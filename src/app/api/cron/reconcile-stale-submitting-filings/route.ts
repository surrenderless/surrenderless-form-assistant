...
/**
 * High-frequency recovery for owned BBB/FTC filings stuck in `delivery_state: "submitting"`.
 * Runs ONLY the stale-submitting reconciler (never the heavier missing-task ensure scan) so it is
 * cheap enough to fire every 15 minutes, matching the reconciler's stale-submitting timeout.
 */
