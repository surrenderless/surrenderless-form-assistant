...
import { reconcileMissingFollowUpResponseReviewTasks } from "@/lib/justice/reconcileMissingFollowUpResponseReviewTasks";
...
async function handleCron(req: NextRequest): Promise<NextResponse> {
  ...
  const summary = await reconcileMissingFollowUpResponseReviewTasks(supabase);
