...
import {
  completePlaywrightMockCfpbOperatorFiling,
...
export async function POST(req: NextRequest) {
  ...
  if (
    ...
    const mockResult = completePlaywrightMockCfpbOperatorFiling({
      caseId,
      userId: mockOwnerId,
      taskId,
  ...
  const result = await completeCfpbOperatorFiling(supabase, ownerResult.userId, {
    caseId,
    taskId,
    destination: b.destination.trim(),
    filedAt: b.filed_at.trim(),
