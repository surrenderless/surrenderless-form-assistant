...
import {
  completePlaywrightMockFtcOperatorFiling,
...
export async function POST(req: NextRequest) {
  ...
  if (
    ...
    const mockResult = completePlaywrightMockFtcOperatorFiling({
      caseId,
      userId: mockOwnerId,
      taskId,
  ...
  const result = await completeFtcOperatorFiling(supabase, ownerResult.userId, {
    caseId,
    taskId,
    destination: b.destination.trim(),
    filedAt: b.filed_at.trim(),
