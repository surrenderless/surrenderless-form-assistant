...
export const metadata: Metadata = {
  title: "Mock BBB complaint form (internal testing)",
  robots: { index: false, follow: false },
};

export default function MockBbbComplaintPage() {
  return (
    <div className="min-h-screen bg-neutral-50 text-neutral-900">
      ...
      >
        ...
        <p className="mt-1 max-w-3xl">
          ...
          endorsed by, or connected to the Better Business Bureau or any real complaint filing system.
          Do not treat submissions here as real complaints.
        </p>
      </div>

      <main className="mx-auto max-w-2xl px-4 py-8 pb-16">
        <h1 className="text-2xl font-bold text-neutral-800">Practice BBB complaint form</h1>
        ...
        <form
          ...
          method="get"
          action="/mock/bbb-complaint"
          id="mock_bbb_complaint_form"
        >
