...
import { resolveJusticeActionResumeSignInPromptContent } from "@/lib/justice/resolveJusticeActionResumeSignInPromptContent";
...
export default function JusticeActionResumeSignInPrompt({
  ...
  const content = resolveJusticeActionResumeSignInPromptContent(hasActiveCase);
  ...
  return (
    <>
      ...
      <main className="mx-auto min-h-[calc(100vh-4rem)] max-w-lg bg-gradient-to-b from-neutral-50 to-neutral-100/80 px-4 py-8 dark:from-neutral-950 dark:to-neutral-900 sm:px-6">
        <h1 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100">{content.heading}</h1>
        <p className="mt-3 text-sm text-neutral-600 dark:text-neutral-400">{content.description}</p>
