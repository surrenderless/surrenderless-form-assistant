...
import type { FccOperatorFilingWorkspace } from "@/lib/justice/fccOperatorFilingWorkspace";
...
export function FccOperatorFilingWorkspacePanel({
  item,
  workspace,
  saving,
  onSubmit,
  ...
  workspace: FccOperatorFilingWorkspace;
  saving: boolean;
  onSubmit: (input: FccRecordInput) => Promise<{ ok: true } | { ok: false; error: string }>;
}) {
  ...
  return (
    <div className="mt-3 space-y-4">
      ...
      >
        <p className="text-xs font-medium text-neutral-800 dark:text-neutral-200">
          Record FCC filing (after portal confirmation)
        </p>
