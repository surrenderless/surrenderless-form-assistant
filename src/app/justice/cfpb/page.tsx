...
import { appendCfpbPrepOpenedOnce, readTimeline, replaceTimelineForCase } from "@/lib/justice/timeline";
        ...
        void (async () => {
          try {
            ...
            if (res.ok) {
              ...
              console.warn("justice cfpb: PATCH /api/justice/cases/[id] failed", res.status);
            }
          } catch (e) {
            console.warn("justice cfpb: PATCH /api/justice/cases/[id] error", e);
          }
        })();
      }
    } catch {
