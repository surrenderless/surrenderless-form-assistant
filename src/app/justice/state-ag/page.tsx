...
function stateNameFromCode(code: string | undefined): string {
...
function buildStateAgComplaintDraft(intake: JusticeIntake): string {
  ...
  const stateLine = intake.consumer_us_state?.trim()
    ...
    : "STATE NOT YET SELECTED — choose your state above before filing.";
