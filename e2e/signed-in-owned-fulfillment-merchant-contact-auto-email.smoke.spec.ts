...
test("owned merchant contact auto email delivery completes in chat without DIY controls", async ({
  page,
}) => {
  ...
  await expect(page.getByText("Merchant contact queued.")).toHaveCount(0);
});
